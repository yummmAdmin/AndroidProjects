...
public class Request
{
    ...
    {
        return "ClassPojo [address_zip_check = "+address_zip_check+", country = "+country+", last4 = "+last4+", funding = "+funding+", address_country = "+address_country+", address_state = "+address_state+", exp_month = "+exp_month+", exp_year = "+exp_year+", address_city = "+address_city+", tokenization_method = "+tokenization_method+", cvc_check = "+cvc_check+", address_line2 = "+address_line2+", address_line1 = "+address_line1+", fingerprint = "+fingerprint+", name = "+name+", id = "+id+", address_line1_check = "+address_line1_check+", address_zip = "+address_zip+", dynamic_last4 = "+dynamic_last4+", brand = "+brand+", object = "+object+", customer = "+customer+"]";
    }
}