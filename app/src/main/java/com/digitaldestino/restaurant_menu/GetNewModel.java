...
public class GetNewModel implements GetNewContract.Model {
    private static final String TAG="GetNewModel";
    @Override
    public void getRestaurantNewMenu(final OnFinishedListener onFinishedListener, HashMap<String, String> param) {
        Retrofit retrofit = RetrofitClient.getRetrofitClient();
        ApiInterface apiInterface = retrofit.create(ApiInterface.class);
        apiInterface.getNewDish(param).subscribeOn(Schedulers.io())
