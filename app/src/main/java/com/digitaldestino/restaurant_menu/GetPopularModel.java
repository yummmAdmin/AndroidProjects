...
public class GetPopularModel implements GetPopularContract.Model {
    private static final String TAG = "GetPopularModel";

    @Override
    public void getRestaurantPopularMenu(final OnFinishedListener onFinishedListener, HashMap<String, String> param) {
        Retrofit retrofit = RetrofitClient.getRetrofitClient();
        ApiInterface apiInterface = retrofit.create(ApiInterface.class);
        apiInterface.getPopularDish(param).subscribeOn(Schedulers.io())
