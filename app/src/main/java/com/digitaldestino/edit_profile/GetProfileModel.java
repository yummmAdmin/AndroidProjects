...
public class GetProfileModel implements GetProfileContract.Model {
    private final String TAG = "EditProfileData";
    ...
    public void getProfileDetails(final OnFinishedListener onFinishedListener, HashMap<String, String> param) {
        ...
        apiInterface.getUserDetails(param).subscribeOn(Schedulers.io())
